  ...
  return ReactDom.createPortal(
    <>
      ...
      <div style={STYLE_MODAL}>
        <BsX style={BTN_MODAL} onClick={OnClose} />
          ...
          <div style={img_display}>
            <div style={img_showcase}>
              <Image
                style={img}
                src={
                  "https://preview.colorlib.com/theme/cozastore/images/product-detail-03.jpg"
                }
              />
              <Image
                style={img}
                src={
                  "https://preview.colorlib.com/theme/cozastore/images/product-detail-01.jpg"
                }
              />
              <Image
                style={img}
                src={
                  "https://preview.colorlib.com/theme/cozastore/images/product-detail-02.jpg"
                }
              />
              <Image
                style={img}
